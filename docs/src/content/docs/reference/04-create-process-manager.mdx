...
See [Retrying on concurrency conflicts](/reference/02-create-aggregate-root/#retrying-on-concurrency-conflicts) for the retry semantics and the purity requirement it places on the dispatched commands.
