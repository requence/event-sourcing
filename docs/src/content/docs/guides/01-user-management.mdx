...
<Aside type="note">
  The in-memory driver stores everything in plain arrays and maps — perfect for learning and prototyping. For production, swap to the Drizzle or SurrealDB driver by changing a single import. See [Drivers](/drivers/01-overview/) for details.
</Aside>
